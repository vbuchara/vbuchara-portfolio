...
/* harmony import */ var _utils_getMeasureFromResizeEntry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @utils/getMeasureFromResizeEntry */ "./src/utils/getMeasureFromResizeEntry.ts");
/* harmony import */ var _utils_hasElementTotallyScrolled__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @utils/hasElementTotallyScrolled */ "./src/utils/hasElementTotallyScrolled.ts");
...
const {
  callbacks
} = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.store)("vbuchara-portfolio/projects", {
  actions: {
    startScrollLeftCardTitle: () => {
      ...
      context.scrollStartTimeout = window.setTimeout((0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.withScope)(starScrollLeft), 500);
    },
    ...
    handleScrollLeft: () => {
      ...
      const cardsElements = context.cardsDivElement.querySelectorAll(".portfolio-projects__card");
    ...
    handleScrollRight: () => {
      ...
      if (!context.cardsDivElement || (0,_utils_hasElementTotallyScrolled__WEBPACK_IMPORTED_MODULE_4__.hasElementTotallyScrolled)(context.cardsDivElement, "horizontal")) return;
      const cardsBoundingRect = context.cardsDivElement.getBoundingClientRect();
      const cardsElements = context.cardsDivElement.querySelectorAll(".portfolio-projects__card");
  ...
  callbacks: {
    onInitCardTitle: () => {
      ...
      context.scrollAnimationController = (0,animejs__WEBPACK_IMPORTED_MODULE_2__["default"])({
    ...
    onRunMainDiv: () => {
      const context = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.getContext)();
      const resizeObserver = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
        return new ResizeObserver(entries => {
          if (!entries[0]) return;
          const entry = entries[0];
          context.mainDivMeasure = (0,_utils_getMeasureFromResizeEntry__WEBPACK_IMPORTED_MODULE_3__.getMeasureFromResizeEntry)(entry);
        });
      }, []);
    ...
    onRunCardsDiv: () => {
      ...
      const resizeObserver = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
        return new ResizeObserver(entries => {
          if (!entries[0]) return;
          const entry = entries[0];
          context.cardsDivMeasure = (0,_utils_getMeasureFromResizeEntry__WEBPACK_IMPORTED_MODULE_3__.getMeasureFromResizeEntry)(entry);
        });
      }, []);
      context.handleOnScroll = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.useCallback)(lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(handleOnScrollCardsDiv, 10, {
        leading: true
      }), []);
      function handleOnScrollCardsDiv(event) {
        const cardsDivElement = event.target;
    ...
    getCardTitleLink: () => {
      ...
      return cardTitleElement.querySelector(".portfolio-projects__card-title-link");
    },
    shouldActiveScroll: () => {
      const context = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.getContext)();
