...
import type { EducationalExperiencePost } from "wordpress-types";
...
export interface EducationalExperienceItemProps {
    experience: EducationalExperiencePost,
    classPrefix?: string,
    htmlId?: string,
    isSkillPage?: boolean,
}

export function EducationalExperienceItem(props: EducationalExperienceItemProps){
    ...
    return (
    <div 
        className={`${classPrefix}__item ${classPrefix}__item--educational`}
        id={htmlId}
    >
        ...
        <h4 className={`${classPrefix}__item-subtitle`}>
            Institution: {experience.acf.institution}
        </h4>
